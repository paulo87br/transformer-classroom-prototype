...
import { TransformerBus, type ConnectionState } from './supabase'
...
export default function LabApp({ room }: { room: string }) {
  const path = window.location.pathname.replace(/\/+$/, '') || '/'
  return path === '/input' ? <InputPage room={room} /> : <DisplayPage room={room} />
}
